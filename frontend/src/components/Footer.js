        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{
              ...
              <a href="https://twitter.com/abbaswhispers" target="_blank" rel="noopener noreferrer" style={{ color: '#8b7355', fontSize: '1.5rem', transition: 'color 0.3s ease' }} onMouseEnter={(e) => e.target.style.color = '#1DA1F2'} onMouseLeave={(e) => e.target.style.color = '#8b7355'}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
